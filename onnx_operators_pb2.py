...
_FUNCTIONPROTO.fields_by_name['node'].message_type = onnx_dot_onnx__pb2._NODEPROTO
...
FunctionProto = _reflection.GeneratedProtocolMessageType('FunctionProto', (_message.Message,), dict(
  ...
  __module__ = 'onnx.onnx_operators_pb2'
